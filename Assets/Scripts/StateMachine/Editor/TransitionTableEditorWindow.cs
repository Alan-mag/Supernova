...
namespace Supernova.StateMachine.Editor 
{
    internal class TransitionTableEditorWindow : EditorWindow
    {
        ...
        {
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreePath>(_uxmlPath);
        ...
        {
            if (obj == PlayModeStateChanged.EnteredPlayMode)
                _doRefresh = true;
        }
        ...
        private void CreateListView()
        {
            ...
            if (_transitionTableEditor && _transitionTableEditor.target)
                listView.selectionIndex = System.Array.IndexOf(assets, _transitionTableEditor.target);
        }
        ...
        private void OnListSelectionChanged(List<object> list)
        {
            ...
            editor.onGUIHandler = () =>
            {
                ...
                CreateListView listView = rootVisualElement.Q<ListView>(className: "table-list");
        ...
        // I dont think this will work because I haven't set up addressables and stuff, right?
