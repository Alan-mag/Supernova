...
public class PlayerData : ScriptableObject
{
    ...
    [Header("Inputs")]
    [ReadOnly(true)] public Vector2 movementInput;
    [ReadOnly(true)] public int leanAxisInput;
    [ReadOnly(true)] public int lifeAmount;
    [ReadOnly(true)] public float buffAmount;
    [ReadOnly(true)] public int numLifes;
    [ReadOnly(true)] public int numSmartBombs;
    [ReadOnly(true)] public int numGoldRings;
    [ReadOnly(true)] public bool isDamageEffect;

    [Header("State")]
    [ReadOnly(true)] public ShipState shipState;
    [ReadOnly(true)] public LeanState leanState;
    [ReadOnly(true)] public BuffState buffState;
    [ReadOnly(true)] public AcrobaticState acrobaticState;
    [ReadOnly(true)] public WeaponState weaponState;
    [ReadOnly(true)] public ChargeWeaponState chargeWeaponState;
    [ReadOnly(true)] public EnemyDetectionState enemyDetectionState;
